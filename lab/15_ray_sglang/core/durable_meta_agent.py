...
class DurableMetaAgent(DurableAgent):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._meta = MetaAgent(config=MetaConfig(
            llm=None,
            generator=generator,
    ...
    def run_research(self, ctx, input: dict) -> dict:
        ...
        # Reset circuit breaker at start of each workflow iteration
        if hasattr(meta._executor, "reset_circuit_breaker"):
            meta._executor.reset_circuit_breaker()
